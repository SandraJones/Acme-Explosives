...
$("#category").bind("change", function() {
    XHRLoad("categories").then(function(catInfo) {
      let cateLoad = catInfo.categories;
      return XHRLoad("types");
    }).then(function(typesInfo) {
      let typLoad = typesInfo.types;
      return XHRLoad("products");
    }).then(function(prodInfo) {
      let prodLoad = prodInfo.products;
      buildProductCards();
    });
  });
});

function XHRLoad (anyFile) {
...
//   };
// };
// var btnDrop = document.getElementById("btn");

// var categoriesClick = function clickListen(){
//     categoriesClick.addEventListener("click", dropDown(){
//       function dropDown(){
//       //show two category choices and grab the objects within categories json file or within the getCategories();       
//       };
//     });
// };
